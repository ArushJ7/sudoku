...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[var(--app-bg)] bg-dot-pattern text-[var(--text-main)] flex flex-col selection:bg-[#CCD8C2] transition-colors duration-200">
      ...
      {/* Main App Canvas */}
      <main className="flex-1 flex flex-col justify-center py-6 px-3 sm:px-6">
        <div className="max-w-[400px] w-full mx-auto">
          <div className="bg-[var(--app-bg)] dark:bg-[#151B12] rounded-3xl border-4 border-[#303F27] dark:border-[#35412B] shadow-xl overflow-hidden min-h-[780px] flex flex-col relative transition-colors duration-200">
